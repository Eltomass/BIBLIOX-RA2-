# BiblioX - Sistema de Gestión de Biblioteca con Agente Funcional

Sistema completo de gestión de biblioteca con inteligencia artificial que implementa un **agente funcional** capaz de razonar, planificar, utilizar herramientas y mantener memoria conversacional.

## 🎯 Características Principales

- **🦾 Agente Inteligente**: Chatbot capaz de razonar y tomar decisiones
- **🔧 Herramientas**: 6 herramientas autónomas para gestión bibliotecaria
- **🧠 Memoria Persistente**: Recuerda nombre, edad, problemas y preferencias del usuario
- **📋 Planificación Automática**: Crea planes multi-paso para objetivos complejos
- **🎯 Adaptación Inteligente**: Se ajusta a respuestas inesperadas
- **Frontend React**: Interfaz moderna y responsive
- **Backend Python**: API REST con FastAPI y modelos locales (Ollama)
...
- **Adaptativo**: Se ajusta a respuestas inesperadas

### Herramientas: 6 funciones autónomas
**¿Por qué estas específicamente?**
- **Cobertura completa**: Cubren flujo bibliotecario end-to-end
- **Especialización**: Cada herramienta tiene un propósito único
- **Autonomía**: Se ejecutan sin intervención manual
- **Composición**: Permiten tareas complejas al combinarlas
...
curl -X POST http://localhost:8000/api/chat \
  ...
  -d '{"question": "Busca libros de Python"}'
```
...
curl -X POST http://localhost:8000/api/plan \
  -H "Content-Type: application/json" \
  -d '{"objective": "Prestar un libro de programación"}'
```
